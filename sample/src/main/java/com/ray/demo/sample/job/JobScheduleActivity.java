...
package com.ray.demo.sample.job;
...
public class JobScheduleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sample_job_schedule);
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            Toast.makeText(JobScheduleActivity.this, "JobSchedule must be used over Lollipop", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_SERVICE_OBJ:
                    ...
                    mTestService.setUiCallback(JobScheduleActivity.this);
            }
        }
    };
    ...
    private boolean ensureTestService() {
        if (mTestService == null) {
            Toast.makeText(JobScheduleActivity.this, "Service null, never got callback?",
